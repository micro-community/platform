...
/* harmony import */ var _new_service_new_service_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./new-service/new-service.component */ "./src/app/new-service/new-service.component.ts");
...
const routes = [
    ...
    { path: 'service/new', component: _new_service_new_service_component__WEBPACK_IMPORTED_MODULE_7__["NewServiceComponent"] },
    { path: 'service/:id', component: _service_service_component__WEBPACK_IMPORTED_MODULE_6__["ServiceComponent"] }
];
...
/* harmony import */ var angular2_notifications__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! angular2-notifications */ "./node_modules/angular2-notifications/fesm2015/angular2-notifications.js");
/* harmony import */ var _service_service_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./service/service.component */ "./src/app/service/service.component.ts");
...
/* harmony import */ var _new_service_new_service_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./new-service/new-service.component */ "./src/app/new-service/new-service.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _service_service_component__WEBPACK_IMPORTED_MODULE_16__["ServiceComponent"],
            _search_pipe__WEBPACK_IMPORTED_MODULE_18__["SearchPipe"],
            _new_service_new_service_component__WEBPACK_IMPORTED_MODULE_19__["NewServiceComponent"]
        ],
        imports: [
...
], LoginComponent.prototype, "githubLogin", null);
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-login',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./login.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/login/login.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./login.component.sass */ "./src/app/login/login.component.sass")).default]
    })
], LoginComponent);
...
NewServiceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-service.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/new-service/new-service.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-service.component.css */ "./src/app/new-service/new-service.component.css")).default]
    })
], NewServiceComponent);
...
let ServiceService = class ServiceService {
    ...
    list() {
        return new Promise((resolve, reject) => {
            return this.http
                .get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl + '/v1/services?token=' + this.us.token())
                .toPromise()
                .then(servs => {
                resolve(servs);
            });
    ...
    logs(service) {
        return new Promise((resolve, reject) => {
            return this.http
                .get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl + '/v1/service/logs?service=' + service + '&token=' + this.us.token())
                .toPromise()
                .then(servs => {
                resolve(servs);
            });
    ...
    stats(service) {
        return new Promise((resolve, reject) => {
            return this.http
                .get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl + '/v1/service/stats?service=' + service + '&token=' + this.us.token())
                .toPromise()
                .then(servs => {
                resolve(servs);
            });
...
let ServiceComponent = class ServiceComponent {
    ...
    valueToString(input, indentLevel) {
        if (!input)
            return "";
...
ServiceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./service.component.css */ "./src/app/service/service.component.css")).default, tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ../../../node_modules/nvd3/build/nv.d3.css */ "./node_modules/nvd3/build/nv.d3.css")).default]
    })
], ServiceComponent);
...
let ServicesComponent = class ServicesComponent {
    constructor(activeRoute, cookie, ses, us) {
        this.activeRoute = activeRoute;
        this.cookie = cookie;
        this.ses = ses;
        this.us = us;
...
let UserService = class UserService {
    ...
    get() {
        return new Promise((resolve, reject) => {
            ...
            return this.http
                .get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl + '/v1/user?token=' + this.token())
                .toPromise()
                .then(user => {
                for (const k of Object.keys(user)) {
                    this.user[k] = user[k];
...
module.exports = __webpack_require__(/*! /home/crufter/code/src/github.com/micro/platform/web/web/src/main.ts */"./src/main.ts");
