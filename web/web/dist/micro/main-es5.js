...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(ServiceComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activeRoute.params.subscribe(function (p) {
            _this3.serviceName = p["id"];

            _this3.ses.list().then(function (servs) {
              _this3.services = servs.filter(function (s) {
                return s.name == _this3.serviceName;
              });
            });

            _this3.ses.logs(_this3.serviceName).then(function (logs) {
              _this3.logs = logs;
            });
          });
        }
        ...
        value: function valueToString(input, indentLevel) {
          ...
          if (input.values) {
            return "".concat(indent).concat(input.type, " ").concat(input.name, " {\n").concat(input.values.map(function (field) {
              return _this4.valueToString(field, indentLevel + 1);
            }).join(fieldSeparator), "\n").concat(indent, "}");
          }
      ...
      _createClass(ServicesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ses.list().then(function (servs) {
            _this5.services = groupBy(servs, "name");
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(UserService, [{
        ...
        value: function get() {
          ...
          return new Promise(function (resolve, reject) {
            if (!_this7.token() || _this7.token().length === 0) {
              setTimeout(function () {
                resolve({});
            ...
            return _this7.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backendUrl + '/v1/user?token=' + _this7.token()).toPromise().then(function (user) {
              for (var _i2 = 0, _Object$keys2 = Object.keys(user); _i2 < _Object$keys2.length; _i2++) {
                var k = _Object$keys2[_i2];
                _this7.user[k] = user[k];
              }
              ...
              _this7.notif.error("User load error", JSON.stringify(e));
            });
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/crufter/code/src/github.com/micro/muweb/web/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
